...
*
* This function is responsible for writing the provided
* array of characters to the standard output.
* @string: A pointer to the array of characters to be written.
* Return: On success, it returns the number of bytes written.
...
*
* This function is used to write the provided
* array of characters to the standard error stream.
* @string: A pointer to the array of characters to be written.
