#include "shell.h"
/**
* builtin_exit - Function to terminate the program
* with a specified status code.
*
* This function is responsible for gracefully terminating the program
* with the specified exit status code.
*
* @param data - The program's data structure.
* @return 0 if the function successfully terminates the program,
